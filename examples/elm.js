...
var _user$project$Perimeter_BoundingRect$getBoundingReactStyle = function (trigger) {
	return trigger ? _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'transform', _1: 'translateZ(0)'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'transition', _1: '1ms all linear'},
				_1: {ctor: '[]'}
			}
						...
						_1: {
							...
							_0: {
								...
								_1: A2(
									...
									_elm_lang$core$Basics$toString(rectangle.top - padding),
									'px')
							},
							_1: {
								ctor: '::',
								_0: {
									...
									_1: A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(rectangle.left - padding),
										'px')
								},
								_1: {
									ctor: '::',
									_0: {
										...
										_1: A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString((rectangle.right - rectangle.left) + (padding * 2)),
											'px')
									},
									_1: {
										ctor: '::',
										_0: {
											...
											_1: A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString((rectangle.bottom - rectangle.top) + (padding * 2)),
												'px')
										},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'background', _1: 'rgba(0,0,255, .4)'},
											_1: {
												ctor: '::',
		...
		switch (_p4.ctor) {
			case 'VerifyBreach':
				...
				return ((_elm_lang$core$Native_Utils.cmp(
					...
					_p10.left - _p8) > 0) && ((_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$Basics$toFloat(_p5),
					_p10.right + _p8) < 0) && ((_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$Basics$toFloat(_p6),
					_p10.top - _p8) > 0) && (_elm_lang$core$Native_Utils.cmp(
					_elm_lang$core$Basics$toFloat(_p6),
					...
					_0: _user$project$Perimeter$Perimeter(
						_elm_lang$core$Native_Utils.update(
							_p9,
							{breached: false})),
					_1: _elm_lang$core$Maybe$Just(_p7.onLeave)
				});
			case 'SetRectangle':
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {buttonText: a, perimeter: b};
	});
var _user$project$Main$PerimeterMsg = function (a) {
	return {ctor: 'PerimeterMsg', _0: a};
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('some head'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					A3(
						...
						model.perimeter,
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(model.buttonText),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						})),
